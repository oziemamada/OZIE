<div class="wrap">
    <div id="satollo-header">
        <a href="http://www.satollo.net/plugins/php-text-widget" target="_blank">Get Help</a>
        ...
        <form style="display: inline; margin: 0;" action="http://www.satollo.net/wp-content/plugins/newsletter/do/subscribe.php" method="post" target="_blank">
            ...
            <input type="hidden" name="nr" value="php-text-widget">
    ...
    <p>The PHP Text Widget official page is <a href="http://www.satollo.net/plugins/php-text-widget">here</a>.</p>

    <p>
        On this panel there are no configurations, it's only here to remember you that PHP Text Widget is active. The plugin is
        extending your standard WordPress text widget letting it to accept PHP code.
    </p>
    <p>
        You don't need to change your already in place text widgets or look for a new one widget!
    </p>
</div>
